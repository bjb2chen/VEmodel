    ...
    def _create_linear_diabatization_input_files(i, filename, qsize):
        ...
        for key in linear_disp_keys:
            ...
            if (ref_geom_flag_exists and gamess_calculation_not_run) or pp.dry_run:
                ...
                try:
                    output_filename = my_subgam(games_filename+'.inp', ncpus=16, ngb=4, nhour=24)
...
def refG_calc(ref_geom_path, **kwargs):
    ...
    # refG_job_result = subprocess_run_wrapper(["./subgam.diab", input_path, "16", "4", "24"], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
    job_path = my_subgam(input_path, ncpus=12, ngb=6, nhour=20)
