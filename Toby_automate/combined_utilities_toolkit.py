""" This program simply combines many utilities needed for preparing the 
diabatization machine-gun model. You can select from a choice of 8 options.
Be sure to provide the correct .out or .dat file as the second argument vector."""
...
def process_dmo_group(file):
    """Assumes that it is operating on Semi-canonical MOs"""

    bash_script = f"""
    echo "You have selected 6 - DMO group, assumption: operating on semi-canonical MOs, please ensure the file given to this script is GMS.dat"
