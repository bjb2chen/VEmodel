...
def mctdh(filnam, modes_included, **kwargs):
    ...
    SOC_flag = kwargs.get('SOC_flag', False)
            ...
            if all(code == 0 for code in [grace_code_plus, grace_code_minus, grace_code_plusx2, grace_code_minusx2]):
                ...
                for ist in range(1, nstate + 1):
                    ...
                    for jst in range(1, jlast + 1):
                        ...
                        print(f"{jst} {ist} {quadratic_offdiag_ev}\n")
...
def main():
    ...
    make_mctdh = mctdh(filnam, modes_included, freqcm=freqcm, qsize=qsize, ha2ev=ha2ev, wn2ev=wn2ev, wn2eh=wn2eh, ang2br=ang2br, amu2me=amu2me, dipoles=dipoles, SOC_flag=True)
