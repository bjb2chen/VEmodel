...
#from ch2nh_project_parameters import *
from apr8_project_parameters import *
...
def create_input_file(source_dir, *args):
    ...
    for operate_string in ["Ex", "Ey", "Ez"]:
        ...
        input_string = "\n\n".join([
            water3Q_input_template.run_section_propagation.format(tfinal=tf/2, tout=0.5, name=f"{xyz_name:}"),
